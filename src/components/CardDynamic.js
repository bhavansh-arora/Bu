        ...
        <ImageBackground source={{uri:props.bg}} imageStyle={{ borderRadius: 5}} style={props.big
            ...
            props.big
              ...
              : styles.position_small_free1}>{props.position}</Text>
                ...
                <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_free1} source={require('../assets/call.svg')} fill={props.fontColor}/>
              ...
              : styles.fields_small_free1}>{props.email}</Text>
                ...
                <View style={styles.fieldspace_free1}>
                <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_free1} source={require('../assets/pin.svg')} fill={props.fontColor}/>
     ...
     ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
      ...
      return(
        ...
        <View style={styles.headercontainer_free2}>
            ...
            <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_free2} source={require('../assets/call.svg')} fill={props.fontColor} />
            ...
            <View style={styles.fieldvalues_free2}>
            <SvgUri width={props.fontSize} height={props.fontSize} style={  styles.icon_free2} source={require('../assets/mail.svg')} fill={props.fontColor}/>
            ...
            <View style={styles.fieldvalues_free2}>
            <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_free2 } source={require('../assets/pin.svg')} fill={props.fontColor}/>
            ...
            <View style={{flexDirection:'row', position:'absolute', bottom:5,left:20}}>
                <SvgUri width={props.fontSize+2} height={props.fontSize+2} style={ styles.icon_free1} source={require('../assets/facebook.svg')} fill={props.fontColor}/>
                <SvgUri width={props.fontSize+2} height={props.fontSize+2} style={ styles.icon_free1} source={require('../assets/instagram.svg')} fill={props.fontColor}/>
                <SvgUri width={props.fontSize} height={props.fontSize} style={  styles.icon_free1} source={require('../assets/mail.svg')} fill={props.fontColor}/>
                </View>
...
<View style={styles.bottomview_premium1}>
    ...
    <View style={styles.bottomrightview_premium1}>
            ...
            <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_premium1} source={require('../assets/call.svg')} fill={props.fontColor}/>
            ...
            <SvgUri width={props.fontSize} height={props.fontSize} style={  styles.icon_premium1} source={require('../assets/mail.svg')} fill={props.fontColor}/>
            ...
            <View style={styles.fieldvalues_premium1}>
            <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_premium1} source={require('../assets/pin.svg')} fill={props.fontColor}/>
...
<View style={styles.bottomrightview_premium2}>
        ...
        <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_premium2} source={require('../assets/call.svg')} fill={props.fontColor}/>
        ...
        <View style={styles.fieldvalues_premium2}>
        <SvgUri width={props.fontSize} height={props.fontSize} style={  styles.icon_premium2} source={require('../assets/mail.svg')} fill={props.fontColor}/>
        ...
        <View style={styles.fieldvalues_premium2}>
        <SvgUri width={props.fontSize} height={props.fontSize} style={ styles.icon_premium2 } source={require('../assets/pin.svg')} fill={props.fontColor}/>
