    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.footer}>
          ...
          appId='436832801020069'
          appSecret='14ce54631c5803ae71ab22bcbecddd14'
      ...
      value={address}/>
          ...
          <Text style={{color:"#fff",fontWeight:"700",fontSize:15}}>Connect to LinkedIn</Text>

          </TouchableOpacity>
          <TouchableOpacity style={styles.instagram} onPress={() => instagramLogin.show()}>
            <Text style={{color:"#fff",fontWeight:"700",fontSize:15}}>Connect to Instagram</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.linkedin} >
          <Text style={{color:"#fff",fontWeight:"700",fontSize:15}}>Connect to Facebook</Text>
